 ...
 */
public class OperasiDuaAngka1 extends javax.swing.JFrame {
    double a,b,c;
    

    /** Creates new form OperasiDuaAngka */
    public OperasiDuaAngka1() {
        initComponents();
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
      //Deklarasi Variabel
        ...
        a = Double.parseDouble(TxtNilai1.getText());
        b = Double.parseDouble(TxtNilai2.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new OperasiDuaAngka1().setVisible(true);
            }
        });
    }
